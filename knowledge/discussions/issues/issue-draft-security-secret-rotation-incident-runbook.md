...
- docs/security/incident-response-secrets.md
- docs/security/data/secret-rotation-matrix.yaml
...
Acceptance Criteria:
- Rotation runbook exists in local docs and covers all secret classes in use.

...
- .github/workflows/*
- SECURITY_ISSUES.md
- docs/security/ci-secrets-wiring.md
- docs/security/data/ci-secret-registry.yaml
...
5. Document the expected secret names, scopes, and owners in local docs.
...
- Local docs contain a CI secret wiring guide with step-by-step setup.

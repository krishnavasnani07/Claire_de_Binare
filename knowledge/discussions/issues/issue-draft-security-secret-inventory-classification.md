...
- docs/security/data/secret-inventory.yaml
...
Acceptance Criteria:
- A single canonical inventory doc exists in local docs with no secret values.
...
Rollback:
- Revert the new inventory files from local docs.

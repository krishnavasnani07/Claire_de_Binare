...
- docs/security/secret-storage-standard.md
- docs/security/secret-storage-quickstart.md
...
6. Document the storage standard in local docs, including where secrets live and which files are allowed.
...
- Local docs contain a storage standard and a quickstart with Windows-friendly steps.
...
- Remove the new local docs pages and keep existing documentation unchanged.

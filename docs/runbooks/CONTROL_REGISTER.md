...
- `security-scan.yml` (PR #2521, gemergt 2026-05-17T20:26:23Z): Grafana-Base-Image in `trivy-scan-base` auf `grafana/grafana:11.6.14-security-04-ubuntu@sha256:adeac4e7...` aktualisiert; compose-Refs (`base.yml`, `compose.red.yml`) und `SERVICE_CATALOG.md` wurden im selben Slice synchron nachgezogen. Trivy-SARIF-Kategorie `trivy-base-grafana` bleibt stabil; keine Aenderung an Triggern, Permissions, Upload-Verhalten oder Control-Surface-Semantik. Kein LR-/Live-/Echtgeld-Signal.

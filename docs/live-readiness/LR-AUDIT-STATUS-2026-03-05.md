...
- Scope basis: `ROADMAP.yaml`, `LR-001..LR-007-STATE.yaml`, `LR-020-STATE.yaml`, `LR-030-STATE.yaml`, `ISSUES.md`, `docs/evidence/LR-030.md`, `docs/evidence/LR-031.md`, the committed P5 artifacts under `reports/p5_canary/2026-04-04/`, the committed LR-030 soak evidence under `reports/lr030/2026-05-17/`, and current GitHub LR issues.
...
- ~~P3 residual uncertainty~~ Resolved 2026-05-17: `LR-031` PASS evidence and `LR-030` zero-execution proof are repo-backed; >24h soak run PASS evidence committed under `reports/lr030/2026-05-17/` (issue [#2440](https://github.com/jannekbuengener/Claire_de_Binare/issues/2440)). P3 is `DONE`.
